...
export function getFactoryAddress(): string {
  ...
  if (network == 'xdai') return '0x45DE240fbE2077dd3e711299538A09854FAE9c9b'
  if (network == 'bsc') return '0x9Ad32bf5DaFe152Cbe027398219611DB4E8753B3'
...
export function getLiquidityTrackingTokenAddresses(): string[] {
  ...
  if (network == 'matic') {
    return [
      ...
      '0xb371248dd0f9e4061ccf8850e9223ca48aa7ca4b', // PLY ??
  ...
  if (network == 'bsc') {
    return [
      ...
      '0x47DcC83a14aD53Ed1f13d3CaE8AA4115f07557C0', //PNDA
...
export function getUsdcNativeCurrencyWrapperPairAddress(): string {
  ...
  if (network == 'bsc') return ADDRESS_ZERO
