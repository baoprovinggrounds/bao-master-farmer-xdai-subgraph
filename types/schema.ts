...
export class BaoswapFactory extends Entity {
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save BaoswapFactory entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save BaoswapFactory entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("BaoswapFactory", id.toString(), this);
  }

  static load(id: string): BaoswapFactory | null {
    return store.get("BaoswapFactory", id) as BaoswapFactory | null;
  }
...
export class BaoswapDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id !== null, "Cannot save BaoswapDayData entity without an ID");
    assert(
      id.kind == ValueKind.STRING,
      "Cannot save BaoswapDayData entity with non-string ID. " +
        'Considering using .toHex() to convert the "id" to a string.'
    );
    store.set("BaoswapDayData", id.toString(), this);
  }

  static load(id: string): BaoswapDayData | null {
    return store.get("BaoswapDayData", id) as BaoswapDayData | null;
  }
