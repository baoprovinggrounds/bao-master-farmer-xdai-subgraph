...
import { updatePairDayData, updateTokenDayData, updateBaoswapDayData, updatePairHourData } from './dayUpdates'
import {
...
export function handleTransfer(event: Transfer): void {
  ...
  let factory = BaoswapFactory.load(getFactoryAddress())
...
export function handleSync(event: Sync): void {
  ...
  baoswap.totalLiquidityNativeCurrency = baoswap.totalLiquidityNativeCurrency.minus(
  ...
  baoswap.totalLiquidityNativeCurrency = baoswap.totalLiquidityNativeCurrency.plus(trackedLiquidityNativeCurrency)
  baoswap.totalLiquidityUSD = baoswap.totalLiquidityNativeCurrency.times(bundle.nativeCurrencyPrice)
...
export function handleMint(event: Mint): void {
  ...
  baoswap.txCount = baoswap.txCount.plus(ONE_BI)
...
export function handleSwap(event: Swap): void {
  ...
  let baoswap = BaoswapFactory.load(getFactoryAddress())
  baoswap.totalVolumeUSD = baoswap.totalVolumeUSD.plus(trackedAmountUSD)
  baoswap.totalVolumeNativeCurrency = baoswap.totalVolumeNativeCurrency.plus(trackedAmountNativeCurrency)
  baoswap.untrackedVolumeUSD = baoswap.untrackedVolumeUSD.plus(derivedAmountUSD)
  baoswap.txCount = baoswap.txCount.plus(ONE_BI)
  ...
  let swaprDayData = updateBaoswapDayData(event)
